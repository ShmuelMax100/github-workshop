...
| # | TODO | Concept | Read this |
|---|---|---|---|
| ④ | `on: workflow_call:` with `python-versions` input | Reusable workflow trigger + the exact input shape | [caching-and-matrix.md → `workflow_call` inputs block (copy this)](../caching-and-matrix.md?plain=1#L140) |
...
| ⑩ | Third-party action via version-pinned `uses:` | Marketplace actions | [security-best-practices.md → `Create GitHub Release` step (copy this block)](../security-best-practices.md?plain=1#L37) |
